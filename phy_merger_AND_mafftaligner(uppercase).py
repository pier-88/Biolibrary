...
alignment_output_file = os.path.join(current_dir, f'alignment_{output_filename}.phy')
...
# Write the alignment to a phy file
alignment_io = StringIO(alignment_stdout)
alignments = AlignIO.parse(alignment_io, 'fasta')
AlignIO.write(alignments, alignment_output_file, 'phylip')
